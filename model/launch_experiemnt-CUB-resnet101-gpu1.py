...
"""
subprocess.run("CUDA_VISIBLE_DEVICES=0 python model/main.py --dataset CUB --cuda --nepoch 300 --pretrain_epoch 0 "
               " --pretrain_lr 1e-4 --classifier_lr 1e-3 --manualSeed 214 --avg_pool "
               " --batch_size 64 --calibrated_stacking 0.7 --all --gzsl  --axioms_exists "
               " --weight_exists --weight_isofclass "
               " --ways 8  --shots 2 --workers 4   --model resnet101  --gpu 0 "
               " --sat_agg_class_outlier_exists --sat_agg_class"
