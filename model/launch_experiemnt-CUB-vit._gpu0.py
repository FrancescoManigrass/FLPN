...
subprocess.run("CUDA_VISIBLE_DEVICES=0 accelerate launch  model/main.py --dataset CUB --cuda "
               " --nepoch 100 --pretrain_epoch 0 "
               " --pretrain_lr 1e-3 --classifier_lr 1e-3 --manualSeed 3131 --avg_pool "
               " --batch_size 32 --calibrated_stacking 0.7 --all --gzsl  --axioms_exists "
               " --optimizer sgd"
               " --weight_exists --weight_isofclass "
               " --ways 32  --shots 1 --workers 8   --model vit  --gpu 0 "
