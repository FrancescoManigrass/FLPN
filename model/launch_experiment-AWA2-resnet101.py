...
"""
subprocess.run("CUDA_VISIBLE_DEVICES=1  python model/main.py --dataset AWA2 --cuda --nepoch 30 --pretrain_epoch 0 "
               " --pretrain_lr 1e-4 --classifier_lr 1e-3 --manualSeed 8275 --avg_pool "
               " --batch_size 64 --calibrated_stacking 0.7 --all --gzsl  --axioms_exists "
               " --weight_exists --weight_isofclass "
               " --ways 16  --shots 2 --workers 4   --model resnet101  --gpu 0 "
               " --sat_agg_class_outlier_exists --sat_agg_class"
               ...
               " --size 448"
                " --sat_agg_same_attribute"
               " --sat_agg_macroclass_implied"
               " --sat_agg_class_cluster_greater --sat_agg_class_cluster_lower --neptune_flag" 
               "  --p 1", shell=True)
