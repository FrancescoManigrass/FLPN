...
subprocess.run("CUDA_VISIBLE_DEVICES=1 accelerate launch model/main.py --dataset SUN --cuda --nepoch 300 --pretrain_epoch 0 "
               " --pretrain_lr 1e-2 --classifier_lr 1e-2 --manualSeed 2347 --avg_pool "
               " --batch_size 32 --calibrated_stacking 0.7 --all --gzsl  --axioms_exists "
               " --weight_exists --weight_isofclass "
               " --ways 12  --shots 12 --workers 4   --model resnet101  --gpu 1"
